...
import 'package:new_flutter_udemy2/models/shopApp/CartModel.dart';
                ...
                SizedBox(
                  ...
                  child: ListView.separated(
                    itemBuilder: (context, index) => Column(
                      children: [
                        buildCartItem(context, ShopCubit.get(context).cartModel!.data!.cartItems![index]),
                      ],
                    ),
                    ...
                    Row(children: [
                      ...
                      IconButton(
                        ...
                        onPressed: (){
                           ...
                           ShopCubit.get(context).postFavorites(model.product!.id);
